...
class TestOpenAIRoutes:  
    ...
    def test_complete_router(self):  
        ...
        response = requests.post("http://localhost:8000/complete", headers=headers, json=data)  
        ...
        credits_response = requests.post("http://localhost:8000/get_credits", headers=headers)  
    ...
    def test_enhance_router(self):  
        ...
        response = requests.post("http://localhost:8000/enhance", headers=headers, json=data)  
    ...
    def test_create_router(self):  
        ...
        response = requests.post("http://localhost:8000/create", headers=headers, json=data)  
